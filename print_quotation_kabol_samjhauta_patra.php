                    ...
                    <div class="printPage">
                        ...
                        <div class="printContent">
                            ...
                            <div class="banktextdetails">
                                ...
                                <br><strong><u>सम्झौताको शर्तहरु:-</u></strong>
                                </br>
                                <ul>
                                    <br>१.	प्राविधिक इष्टिमेट/स्वीकृत लागत अनुमान बमोजिम <?= $data1->program_name ?> कार्य मिति <?= convertedcit($quotation_more_details->yojana_end_date) ?> भित्रमा सम्पन्न गरिसक्नुपर्नेछ ।
                                    <br>२.	बुँदा नम्बर १ (एक) बमोजिमको कार्य सम्पन्न गरे पश्चात सम्बन्धित प्राविधिक मूल्यांकन प्रतिवेदन, वडा कार्यालयको सिफारिस, अनुगमन समितिको प्रतिवेदन, सम्पन्न योजनाको फोटो, बील-भरपाइ एवं अन्य आवश्यक कागजातहरुको आधारमा प्रथम पक्षले दोश्रो पक्षलाई जम्मा स्वीकृत रकम रु <?= convertedcit(placeholder($max_value)) ?>  अक्षरेपी <?= convert($max_value) ?> मात्र (मू.अ. करसहित) उपलब्ध गराउने छ ।
                                    <br>३.	प्रथम पक्षले दोश्रो पक्षलाई रकम भुक्तानी गर्दा १.५ आय कर कट्टी गरी 	बाँकी रकम मात्र भुक्तानी गरिने छ । अन्य नियमानुसार नेपाल सरकार वा 	अन्य निकायलाई कुनै शुल्क वा जरीवाना बुझाउनु परेमा स्वयं दोश्रो पक्षले 	व्यहोर्नु पर्नेछ ।
                                    <br>४.	प्राविधिक इष्टिमेट बमोजिम गुणस्तरयुक्त सामग्री उपलब्ध गराउनु दोश्रो पक्षको कर्तव्य हुनेछ ।
                                    <br>५.	अन्य शर्तहरु सार्वजनिक खरीद ऐन, २०६३, सार्वजनिक खरीद नियमावली, २०६४ र अन्य प्रचलित कानून बमोजिम हुनेछ ।
                                </ul>
                            </div>
                            <div class="myspacer30"></div>

                            <div class="oursignature mymarginright"> कार्यालयको तर्फबाट  <br>
                            ...
                            <div class="oursignatureleft mymarginright"> ठेकेदारको तर्फबाट <br/>
                                <?=$name1?>
                            </div>
