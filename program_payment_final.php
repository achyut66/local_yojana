                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="text-right">
                                                जम्मा कर कट्टी <label><input type="text" id="total_kar" readonly="true" style="border:none" /></label><br>
                                                जम्मा कोष कट्टी<label><input type="text" id="kos_katti" readonly="true" style="border:none"/></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
