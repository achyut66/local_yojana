                    ...
                    <div class="inputWrap2">
                        ...
                        <div class="inputWrap33 inputWrapLeft">
                            ...
                            <div class="newInput"><select name="type" required>
                                ...
                                <div class="newInput"><input type="text" id="rajpatra_no"  name="rajpatra_no" ></div>
                                <div class="titleInput">शिर्षक नं</div>
                                <div class="newInput"><input type="text" id="topic_no"  name="topic_no" ></div>
                            ...
                            <div class="newInput" id="appent_anudan_kisim">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <input type="text" name="amount[]" id="amount" placeholder="रकम">
                                        </td>
                                        <!-- <td></td> -->
                                        <!-- <td>
