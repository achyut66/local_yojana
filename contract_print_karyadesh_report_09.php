...
$newdata1 = 'सार्बजनिक खरिद ऐन २०६३ को नियम २५ बमोजिम';
...
<body>
 ...
 |  <a class="btn" href="contract_letter_dashboard.php"> पछी  जानुहोस </a></h2>
                    ...
                    <div class="OurContentFull" >
                       <form method="get" id="form" action="contract_print_karyadesh_report_09_final.php?>">
...
//                                                     print_r($result);exit;
                                        ...
                                        <div class="bankdetails">
                                          ...
                                          <?php echo $name->contractor_name;?> को रित पुर्बकको  कबोल अंक सबै भन्दा घटी रकम ( भ्याट बाहेक ) 
                                          रु <?php echo convertedcit(placeholder($data5->bid_amount));?>   अक्षरुपी 
                                          <?= convert($data5->bid_amount)?> मात्र भएकाले 
