               ...
               <?php } else {?>
                    ...
                    <?php $data=Plantotalinvestment::find_by_plan_id($data->id);?>
                     ...
                     <div>
                            ...
                            <div class="inputWrap100">
                            	<div class="inputWrap33 inputWrapLeft text-left">
                                    <!-- <div class="add_more btn myWidth100">थप्नुहोस [+]</div> -->
                                    <input type="button" class="add_more button btn-danger" value="थप्नुहोस [+]">
                                </div>
                                <div class="inputWrap33 inputWrapLeft text-center">
                                    <!-- <div class="remove_more btn myWidth100">हटाउनुहोस [-]</div> -->
                                    <input type="button" class="remove_more button btn-danger" value="हटाउनुहोस [-]">
                                </div>
                                <div class="inputWrap33 inputWrapLeft text-right">
                                    <input type="submit" name="submit" value="<?=$value?>" class="submit button btn-success myWidth33">
                                </div>
