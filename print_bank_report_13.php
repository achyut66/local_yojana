...
$newdata1 = '२०६४ को नियम ९७ को उपनियम ९';
$newdata2 = 'उपनियम १० वमोजिम';
//dynamic data
$upabhokta_letter_content = UpabhoktaLetterContent::find_by_letter_plan_id('ward_running_bhuktani',$_GET['id']);
...
<body>
    ...
    <div id="body_wrap_inner"> 
    	<div class="maincontent" id="div_new">
    	    <form method="get" id="form" action="print_bank_report_13_final.php">
									...
									<div class="chalanino">चलानी नं: </div>
                                       ...
                                       <?php echo SITE_ADDRESS;?> <!--(योजनाको संचालन गर्ने उपभोक्ता समितिको ठेगाना)-->
										...
										<div class="banktextdetails"  >
											यस <strong><?php echo SITE_TYPE;?></strong> वडा नं. 
                                            <strong><?php echo convertedcit($data1->ward_no)?></strong> मा संचालित 
                                            <strong><?php echo $data1->program_name?></strong> योजनाको लागि यस
											<strong><?php echo SITE_TYPE;?></strong>को 
                                            <strong><?php echo $data3->program_organizer_group_name?></strong>बाट विनियोजित रकम रु. 
											...
											लागी मिति <strong><?php echo convertedcit($data2->miti);?></strong> 
                                            मा <strong><?php echo $data3->program_organizer_group_name;?></strong>
                                            उपभोक्ता समितिबाट अनुरोध भइ आएकोमा सो योजना 
                                            <input type="hidden" id="data1" name="data1"
                                                value="<?=$newdata1?>">
                                            <span style="border-bottom: 1px solid #6c6b6b;" id="data1_new"
                                                contenteditable="true"><?=$newdata1?>
                                            </span>
                                            मा व्यवस्था भए अनुसार उपभोक्ता समिति वा लाभग्राही समुदायबाट संचालित हुने निर्माण 
                                            कार्यमा लोडर, ऐक्साभेटर, डोजर, ग्रेडर विटुमिन डिस्ट्रीव्युटर, विटुमिन व्याइलर 
                                            जस्ता हेव्वी मेसिनहरु प्रयोग नगरि श्रममुलक प्राविधिबाट कार्य गराउने गरी लागत 
                                            अनुमान स्वीकृत गराई सोही बमोजिम सम्झौता गरी मेशिनरी उपकरणको प्रयोग र 
                                            <input type="hidden" id="data2" name="data2"
                                            value="<?=$newdata2?>">
                                            <span style="border-bottom: 1px solid #6c6b6b;" id="data2_new"
                                            contenteditable="true"><?=$newdata2?>
                                            </span> 
