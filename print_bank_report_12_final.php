...
//dynamic data
$upabhokta_letter_content = UpabhoktaLetterContent::find_by_letter_plan_id('ward_antim_bhuktani_tippani',$_GET['id']);
if(empty($upabhokta_letter_content))
{
    ...
    $upabhokta_letter_content->letter_name = 'ward_antim_bhuktani_tippani';
...
<body>
    <div class="myPrintFinal" > 
    	<div class="userprofiletable" id="div_new">
             <div class="printPage">
									...
									<div class="printContent">
                                       ...
                                       <?php echo SITE_ADDRESS;?> <!--(योजनाको संचालन गर्ने उपभोक्ता समितिको ठेगाना)-->
										...
										<div class="banktextdetails"  >
											...
											बाट मिति <strong><?php echo convertedcit($data2->yojana_sakine_date)?></strong> 
                                            मा सम्पन्न भएको योजनाको कार्य सम्पन्न गरि भुक्तानीको 
											लागी मिति <strong><?php echo convertedcit($data2->miti);?></strong> मा 
                                            <strong><?php echo $data3->program_organizer_group_name;?></strong> उपभोक्ता समितिबाट 
                                            अनुरोध भइ आएकोमा सो योजना 
                                            <?=$new_data1?>
                                            मा व्यवस्था भए अनुसार उपभोक्ता समिति वा लाभग्राही समुदायबाट संचालित हुने निर्माण कार्यमा लोडर, 
                                            ऐक्साभेटर, डोजर, ग्रेडर विटुमिन डिस्ट्रीव्युटर, विटुमिन व्याइलर जस्ता हेव्वी मेसिनहरु प्रयोग नगरि 
                                            श्रममुलक प्राविधिबाट कार्य गराउने गरी लागत अनुमान स्वीकृत गराई सोही बमोजिम सम्झौता गरी मेशिनरी 
                                            उपकरणको प्रयोग र 
                                            <?=$new_data2?>
                                             कुनै निर्माण व्यवसायी वा सव–कन्ट्राक्टरबाट कार्य नगरेको पाईएकोले उक्त योजनाको रकम 
                                             अन्तिम भुक्तानी दिनहुन हाम्रो सिफारिस मन्जुर छ । 
										</div>
