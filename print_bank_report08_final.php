...
if(empty($upabhokta_letter_content))
{
    ...
    $upabhokta_letter_content->letter_name = 'upabhokta_tippani_patra';
...
<body>
    <div class="myPrintFinal" id="div_print"> 
               ...
               <div class="image-wrapper">
                ...
                <div class="image-wrapper">
                   ...
                   <div class="printContent">
                    ...
                    <div class="text-center">तपसिल</div>
                       ...
                       <div class="banktextdetails">
                                ...
                                <?=$new_data2?> अनुरुप रु. १ करोड सम्मको लागत अनुमान भयको 
