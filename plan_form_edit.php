...
if(isset($_POST['submit']))
  {
        ...
        $data->rajpatra_no= $_POST['rajpatra_no'];
        $data->topic_no= $_POST['topic_no'];
                        	 ...
                        	 <form method="post" enctype="multipart/form-data">
                             	<div class="inputWrap100">
                                	...
                                	<div class="inputWrap33 inputWrapLeft">
                                        ...
                                        <div class="titleInput">राजपत्र नं : </div>
                                        <div class="newInput"><input type="text" id="rajpatra_no" name="rajpatra_no" value="<?php echo $result->rajpatra_no;?>" /></div>
                                        <div class="titleInput">शिर्षक नं : </div>
                                        <div class="newInput"><input type="text" id="topic_no" name="topic_no" value="<?php echo $result->topic_no?>" /></div>
