                            ...
                            ?>
                                ...
                                <tr id="remove_estimate_detail-<?=$count?>"
                                    ...
                                    <td><img id="break-<?=$count?>"
                                            class="row_delete" src="images/cross.png" width="20px" height="20px" /></td>
                                    <!--                                <td>
                                ...
                                <tr id="break_row-<?=$count?>_<?=$j?>"
                                    ...
                                    <td
                                        ...
                                        <select
                                            ...
                                            <?php foreach ($units as $unit): ?>
                                            <option <?php if ($break_lagat->unit_id == $unit->id) {
                                        echo 'selected';
                                    } ?>
                                                value="<?=$unit->id?>">
                                                <?=$unit->name?>
                                    ...
                                    <td><input type="text"
                                            id="task_rate-<?=$count?>_<?=$j?>"
                                            value="<?=$break_lagat->task_rate?>"
                                            name="task_rate-<?=$count?>[]"
                                            class="myWidth100" />
                                    </td>
                                    <td><input type="text"
                                            id="total_rate-<?=$count?>_<?=$j?>"
                                            value="<?=$break_lagat->total_rate?>"
                                            name="total_rate-<?=$count?>[]"
                                            class="myWidth100" />
                                    </td>
                                ...
                                <tr
                                    ...
                                    <td><input type="text"
                                            id="task_rate-<?=$count?>"
                                            name="task_rate[]"
                                            value="<?=$lagat_detail->task_rate?>"
                                            class="myWidth100"></td>
                                    <td><input type="text"
                                            id="total_rate-<?=$count?>"
                                            name="total_rate[]"
                                            value="<?=$lagat_detail->total_rate?>"
                                            class="myWidth100"></td>
                             ...
                             ?>
                                <tr id="remove_estimate_detail-<?=$count?>"
                                    ...
                                    <td><input type="text"
                                            ...
                                            value="<?=$single_break->length?>" />
                                    </td>
                                    <td><input type="text"
                                            id="breadth-<?=$count?>"
                                            name="breadth[]" class="myWidth100"
                                            value="<?=$single_break->breadth?>" />
                                    </td>
                                    <td><input type="text"
                                            id="height-<?=$count?>"
                                            name="height[]" class="myWidth100"
                                            value="<?=$single_break->height?>" />
                                    </td>
                                    <td><input type="text"
                                            id="total_evaluation-<?=$count?>"
                                            name="total_evaluation[]"
