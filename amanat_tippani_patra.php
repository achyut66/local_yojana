...
//static data
$newdata1 = 'सार्वजनिक खरीद नियमावली २०६४ को नियम ९८ (३) वमोजिम';
    ...
    <div id="body_wrap_inner"> 
        <div class="maincontent" id="div_new">
            ...
            <div class="OurContentFull" >
                <form method="get" id="form" action="amanat_tippani_patra_print.php?>" target="_blank" >
                       ...
                       <div class="printPage">
                           ...
                           <div class="printContent">
                              ...
                              <div class="banktextdetails"  >
                               ...
                               <strong><?php echo $data1->program_name;?></strong> कार्यको लागि लागत अनुमान सहित रकम उपलब्ध 
                               गराई दिन हुन अनुरोध भई आएकोमा <strong><?php echo $data3->aadesh_per_post;?></strong>वाट <strong>
                                   <?php echo Topicbudget::getName($data1->budget_id);?></strong>वाट कार्य गराउने आदेश भए वमोजिम 
                                   उक्त कार्यको लागी तयार भएको लागत अनुमान रू.<strong><?php echo convertedcit($data2->total_investment);?>
                                </strong> स्विकृत गरी चालु आर्थिक वर्ष <strong><?php echo convertedcit($fiscal->year)?></strong>  
                                को वार्षिक कार्यक्रमको <strong><?php echo Topicareatype::getName($data1->topic_area_type_id)?>
                            </strong> को <strong><?php echo Topicbudget::getName($data1->budget_id);?></strong>वाट खर्च लेख्ने गरी 
                            <input type="hidden" id="data1" name="data1"
                                        value="<?=$newdata1?>">
                                    <span style="border-bottom: 1px solid #6c6b6b;" id="data1_new"
                                        contenteditable="true"><?=$newdata1?>
                            </span> 
