             ...
             <div class="myspacer30"></div>
             	<div class="image-wrapper">
									...
									<div class="printContent">
										...
										<div class="myspacer"></div>
										उपरोक्त बिषयमा यस <b><?php echo SITE_TYPE;?></b> र <b><u><?php echo $data->program_organizer_group_name;?>
														</u></b><!--(योजनाको संचालन गर्ने उपभोक्ता समितिको नाम)--> बिच मिति <b><?php echo convertedcit($data2->miti);?> 
														</b><!--(योजना संझौता भएको मिति)--> मा <b><?php echo $data1->program_name;?></b> योजना संचालन गर्ने भनि संझौता
														भएकोमा उक्त्त योजना संचालन गर्न उपभोक्ता समितिको नाममा बैंक खाता आबश्यक भएकाले उपभोक्ता समितिका 
														<?php if(!empty($_GET['adaksh'])){
														    echo $_GET['adaksh'];
														}else{}?>
														</b><!--(नामथर)--> ,
														<?php if(!empty($_GET['sachib'])){
														    echo $_GET['sachib']; 
														}else{}?><!--(नामथर)--> 
														<?php if(!empty($_GET['kosh'])){
														    echo $_GET['kosh'];
														}else{}?>
														<!--(नामथर)-->
