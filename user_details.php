...
include("menu/header_script.php");?>
    <div id="body_wrap_inner"> 
                ...
                <div class="maincontent">
                    <h2 class="headinguserprofile">प्रयोगकर्ताको  प्रोफाइल 
                        <a href="user1.php"><button class="button btn-success">प्रयोगकर्ता थप्नुहोस+</button></a> 
                        <a href="index.php"><button class="button btn-danger">पछि जानुहोस</button></a>
                    </h2>
                        ...
                        <div class="userprofiletable">
                            <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="myCenter">
                                                <a href="user_edit.php?id=<?=$data->id?>" class="btn">सच्याउनुहोस</a></td>
                                        </tr>
                                        <?php endforeach; ?>
                        </table>
                        </div>
