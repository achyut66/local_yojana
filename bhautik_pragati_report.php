    ...
    echo 'selected="selected"';
           ...
           ?>
                    <div class="myPrint"><a target="_blank"
                            href="bhautik_pragati_report_print.php?date_from=<?=$_POST['date_from']?>&date_to=<?=$_POST['date_to']?>&type=<?php echo $type;?>&ward_no=<?=$_POST['ward_no']?>">प्रिन्ट
                            गर्नुहोस</a> </div><br>
                    <a
                        href="bhautik_pragati_report_excel.php?date_from=<?=$_POST['date_from']?>&date_to=<?=$_POST['date_to']?>&ward_no=<?=$_POST['ward_no']?>&type=<?= $type ?>">Export
                        to excel</a>-->
                    ...
                    <?php if ($_POST['type']==0) { ?>
                    <div class="subjectboldright"><b><?php if (!empty($_POST['ward_no'])) {
               echo "वडा नं ". convertedcit($_POST['ward_no']). " को  ".$name." बिस्तृत रिपोर्ट हेर्नुहोस ";
           } elseif (!empty($_POST['ward_no']) && !empty($_POST['date_from']) && !empty($_POST['date_to'])) {
               echo "वडा नं ". convertedcit($_POST['ward_no']). " को  ".$name." मिति ".convertedcit($_POST['date_from'])." देखि मिति  ".convertedcit($_POST['date_to'])." सम्मको बिस्तृत रिपोर्ट हेर्नुहोस ";
           } elseif (empty($_POST['ward_no']) && !empty($_POST['date_from']) && !empty($_POST['date_to'])) {
               echo $name." मिति ".convertedcit($_POST['date_from'])." देखि मिति  ".convertedcit($_POST['date_to'])." सम्मको बिस्तृत रिपोर्ट हेर्नुहोस ";
           } else {
               echo $name." बिस्तृत रिपोर्ट हेर्नुहोस ";
           };?>
                        </b></div>
                    ...
                    <table class="table table-bordered table-hovtoer table-striped">
                        <thead>
                            <tr class="title_wrap">
                                ...
                                <td class="myCenter"
                                    colspan="<?=$count_bhautik_lakshya?>">
                                    <strong>भौतिक लक्ष्य </strong>
                                </td>
                                <td class="myCenter"
                                    colspan="<?=$count_bhautik_lakshya?>">
                                    <strong>प्राप्त लक्ष्य </strong>
                                </td>
               ...
               foreach ($topic_area_type_ids as $topic_area_selected) { ?>
                        <tr>
                            <td colspan="<?=9+$count_bhautik_lakshya?>"
                                class="myCenter">
                        ...
                        <tr>
                            <td colspan="<?=9+$count_bhautik_lakshya?>"
                                class="myCenter"> <b><?php echo Topicareatypesub::getName($topic_area_type_sub_id); ?></b>
                            </td>
                        </tr>
                        <?php
                                                        $j=1;
                        ...
                        <tbody style="height: 10px !important; overflow: scroll; ">
                            <tr>
                                ...
                                <td class="myCenter"><?php echo convertedcit($j); ?>
                                </td>
                                <td class="myCenter"><?php echo convertedcit($data->id); ?>
                                </td>
                                <td class="myCenter"><?php echo $data->program_name; ?>
                                </td>
                                <td class="myCenter"><?php echo convertedcit($data->ward_no); ?>
                                </td>
                                <td class="myCenter"><?php echo Topicareaagreement::getName($data->topic_area_agreement_id); ?>
                                </td>
                                <?php foreach ($bhautik_lakshya_topics as $topic):
                                                                                 $quantity = Bhautik_lakshya::find_by_plan_id_detail_id_type($data->id, $topic->id, 1);
//                                                                                 print_r($quantity);?>
                                <td class="myCenter"><?= convertedcit($quantity->qty)?>
                                </td>
                                <?php endforeach; ?>
                                <?php foreach ($bhautik_lakshya_topics as $to):
...
//                                                                                print_r($qty_result);
                                ...
                                <td class="myCenter"><?=convertedcit($quantitys)?>
                                </td>
                                <?php endforeach; ?>
                            </tr>
                        </tbody>
