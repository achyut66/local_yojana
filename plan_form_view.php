                    ...
                    <div class="OurContentFull">
                     ...
                     <table class="table table-bordered table-hover">
                                <tr>   
                                    ...
                                    <td class="myCenter">निस्क्रिय गर्नुहोस</td>
                                ...
                                <tr>
                                    ...
                                    <td class="myCenter">
                                    <a href="deactivate_plan_id.php?id=<?php echo $data->id;?>">
                                    <button class="button btn-danger">निस्क्रिय गर्नुहोस</button>
                                  </a>
                                    </td>
                                    </tr>
                                    <?php }else{?>
...
?>
    ...
    <!-- <script>
      //Code Starts
      JQ(document).on("click", "#erase_id", function() {
        var num = JQ(".remove_plan_form_details").length;
        var counter = num + 1;
        var param = {};
        param.counter = counter;
        JQ.post('deactivate_plan_id.php', param, function(res) {
