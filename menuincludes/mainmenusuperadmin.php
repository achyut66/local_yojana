...
$mode= getUserMode();
$user = getUser();
$plan_list = EstimateLagatProfile::find_by_sql("select * from estimate_lagat_profile where in_review = 1 order by date_english asc");
...
<div class="mainmenu">
        ...
        <ul>
            ...
            <li><a href="settings.php">सेटिंग</a>
                <ul>
                    ...
                    <li><a href="import.php">दाइत्तो सार्नुहोस</a></li>
            ...
            <li><a href="view_plan_dashboard.php">योजना / कार्यक्रम हेर्नुहोस </a>
                <ul>
                    ...
                    <li><a href="view_topic_wise_report.php">बिषयगत क्षेत्रको किसिम अनुसार योजना/कार्यक्रम हेर्नुहोस</a>
                    </li>
                </ul>
            </li>
            <?php endif; ?>
    ...
    ?>
                                ...
                                <ul>
                                    ...
                                    <li><a href="dashboard_bhuktani.php">योजनाको सिफारिस </a>
                                        <ul>
                                            ...
                                            <li><a href="print_bank_report_13.php">मुल्यांकनको आधारमा भुक्तानीको सिफारिस
                                                </a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="print_bank_report_09.php">मुल्यांकनको आधारमा भुक्तानीको टिप्पणी</a>
                                    </li>
        ...
        ?>
                        <ul>
                            ...
                            <li><a href="amanat_bhuktani_dashboard.php">भुक्तानी</a>
                                <ul>
                                    <li><a href="plan_form2.php">पेश्की भुक्तानी</a></li>
                                    <li><a href="amanat_plan_form4.php">मुल्यांकनको आधारमा भुक्तानी</a></li>
                                    <li><a href="amanat_plan_form5.php">अन्तिम भुक्तानी</a></li>
                                    <li><a href="additionaldate.php">म्याद थप</a></li>
                                    <li><a href="yojanadharauti.php">धरौटी फिर्ता</a></li>
                    ...
                    <li><a href="samiti_setid.php">संस्था मार्फत</a>
                        ...
                        <ul>
                            <li><a href="samiti_kul_lagat_dashboard.php">योजनाको कुल लागत अनुमान / फोटो हाल्नुहोस</a>
                            </li>
                            ...
                            <li><a href="samiti_letters_select.php">पत्रहरु</a>
                                <ul>
                                    ...
                                    <li><a href="samiti_additional_date_tippani_letter.php">म्यादको थपको टिप्पणी</a>
                                    </li>
                                    <li><a href="samiti_add_date_letter.php">म्यादको थपको पत्र</a></li>
                                    <li><a href="samiti_analysis_letter.php">मुल्यांकनको आधारमा भुक्तानीको टिप्पणी</a>
                                    </li>
                            ...
                            <li><a href="samiti_bhuktani_select.php">भुक्तानी</a>
                                <ul>
                                    <li><a href="plan_form2.php">पेश्की भुक्तानी </a></li>
                                    <li><a href="samiti_plan_form4.php">मुल्यांकनको आधारमा भुक्तानी</a></li>
                                    <li><a href="samiti_plan_form5.php">अन्तिम भुक्तानी</a></li>
                                    <li><a href="additionaldate.php">म्याद थप</a></li>
                    ...
                    <li><a href="contract_set_id.php">ठेक्का मार्फत</a>
                        ...
                        <ul>
                            ...
                            <li><a href="contract_letter_dashboard.php">पत्रहरु</a>
                                <ul>
                                    <li><a href="contract_print_karyadesh_report_09.php">ठेक्का सम्झौताको टिप्पणी </a>
                                    </li>
                                    ...
                                    <li><a href="contract_print_karyadesh_report_03.php">पेश्की कार्यदेशको टिप्पणी</a>
                                    </li>
                                    ...
                                    <li><a href="contract_print_karyadesh_report_06.php">मुल्यांकनको आधारमा भुक्तानीको
                                            टिप्पणी</a></li>
                                    <li><a href="contract_print_karyadesh_report_07.php">अन्तिम भुक्तानीको टिप्पणी</a>
                                    </li>
            ...
            <?php endif;?>
            <?php if ($mode=="superadmin" || $mode=="subadmin" || $mode=="maker"):?>
        ...
        ?>
            ...
            <li><a href="report_section.php">रिपोर्ट हेर्नुहोस</a>
                <ul>
                    ...
                    <li><a href="anusuchi_dashboard.php">खर्च प्रतिबेदन </a>
                        <ul>
                            ...
                            <li><a href="sarans_expenditure_report.php">बिषयगत क्षेत्र / बजेट उपशीर्षक अनुसार खर्च
                                    विवरण</a></li>
            ...
            <?php endif;?>
            <?php if ($mode=="superadmin" || $mode=="checker"):?>
            <li><a href="maker_checker.php">मेकर चेकर <span style="color:red;font-weight:bold">(<?php echo count($plan_list) + count($abstract_list); ?>)</span></a>
            </li>
            <!--<li><a href="http:/bmsnepal.net">योजना / कार्यक्रम </a></li>-->
            <?php endif;?>
        </ul>
    </nav>
</div><!-- main menu ends -->