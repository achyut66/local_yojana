    	...
    	<div class="">
            <div class="">
                ...
                <div class="maincontent" id="div_new">
                   <form method="get" action="samiti_peski_samjhauta_karyadesh_final.php?>">
                    ...
                    <div class="OurContentFull" >
                    	...
                    	<div class="myPrint">
                            <input type="hidden" name="id" value="<?=$_GET['id']?>" /><input type="submit" value="प्रिन्ट" name="submit" /></div>
                    	</h2> 
