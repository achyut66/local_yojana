...
// static contents
$content_1 = 'सार्वजनिक खरिद नियमावलीको नियम १४ को उपनियम (१) वमोजिम';
$content_2 = 'सार्वजनिक खरिद नियमावलीको नियम ८५ को उपनियम (१) (क) तथा सोही नियमावलीको नियम ८५ को उपनियम (४) वमोजिमको';
// dynamic contents
$all_contents = QuotationLetterContent::find_by_letter_plan_id('quotation_lagat_anuman', $_GET['id']);
if (!empty($all_contents)) {
    if (!empty($all_contents->content_1)) {
        $content_1 = $all_contents->content_1;
    }
    if (!empty($all_contents->content_2)) {
        $content_2 = $all_contents->content_2;
    }
}
?>
...
//            echo '</pre>';exit;
            ?>
                <form id="form" method="get"
                    action="quotation_lagat_anuman_print.php?id=<?= $_GET['id'] ?>"
                    target="_blank">
          ...
          ?>)
                                    ...
                                    लागत अनुमान <input type="hidden" id="content_1_value" name="content_1"
                                        value="<?=$content_1?>">
                                    <span style="border-bottom: 1px solid #6c6b6b;" id="content_1"
                                        contenteditable="true"><?=$content_1?></span> स्वीकृत गरी
                                    <strong><?=$data1->program_name?></strong>
                                    कार्य <input type="hidden" id="content_2_value" name="content_2"
                                        value="<?=$content_1?>">
                                    <span style="border-bottom: 1px solid #6c6b6b;" id="content_2"
                                        contenteditable="true"><?=$content_2?></span>
    ...
    <script>
        JQ(document).ready(function() {
            JQ(document).on("submit", "#form", function(e) {
                JQ('#content_1_value').val(JQ('#content_1').text());
                JQ('#content_2_value').val(JQ('#content_2').text());
            });
        });
    </script>
