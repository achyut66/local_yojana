    ...
    <div class="col col-lg-12 col-md-12 col-sm-12 col-xs-12 maincontent">
                    ...
                    <h1 class="myHeading1"><?=$plan_selected->program_name?></h1>
                      ...
                      <h1 style="color:red;" class="myHeading1"><?php echo $_GET['msg'];?></h1>
                       <?php endif;?>
                      <?php if($user->mode=="administrator"||$user->mode=="subadmin" ||$user->mode=="maker"||$user->mode=="superadmin" || $user->mode=="section"):?>
                      <a href="kul_lagat_dashboard.php" target="_blank">
                      ...
                      <!-- <div class="card"> -->
                          <div class="col-md-12">
                              <div class="row">
                                    ...
                                    <div class="col-md-4">
                                    <a href="plan_form1_1.php" target="_blank">
                                        <p id="rcorners1" class="text-center" style="font-size: 22px;">उपभोक्ता समिति विवरण<br>
                                        <img src="images/upabhokta-icon.png" alt="Upabhokta Icon" class="dashimg" />
                                    </p>
                                    </a>
                                    </div>
                                    <div class="col-md-4">
                                    <a href="plan_form1_2.php" target="_blank">
                                        <p id="rcorners1" class="text-center" style="font-size: 22px;">अनुगमन समिति विवरण<br>
                                        <img src="images/n/anugaman1.png" alt="Upabhokta Icon" class="dashimg" />
                                    </p>
                                    </a>
                                    </div>
                                    <div class="col-md-4">
                                    <a href="plan_form1_3.php" target="_blank">
                                    ...
                                    <div class="col-md-4">
                                    <a href="letters_select.php" target="_blank">
                                    ...
                                    <div class="col-md-4">
                                    <a href="bhuktani_select.php" target="_blank">
