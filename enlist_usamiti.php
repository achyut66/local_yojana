                ...
                <div class="userprofiletable">
                     ...
                     <table class="table table-bordered table-hover">
                         <tr>       <td class="myCenter"><strong>सि.नं.</strong></td>
                                    ...
                                    <td class="myCenter"><strong>उपभोक्ता समितिको कालो सुची</strong></td>
                                ...
                                <tr>
                                    ...
                                    <td class="myCenter">
                                        <a href="enlist_upabhokta_samiti.php?id=<?= $data->id ?>" class="btn">विवरण</a>
                                        <a href="settings_upabhokta_samiti_add.php?id=<?= $data->id ?>" class="btn">सच्याउनुहोस</a>
                                        <a href="print_bank_report_enlist.php?id=<?= $data->id ?>" class="btn">पत्र</a>
                                    </td>
                                    <td class="myCenter">
                                        <a href="black_list_reason.php?id=<?= $data->plan_id?>" class="btn btn-danger">कालो सुची</a>
                                    </td>
                                </tr>
                         <?php $i++; 
