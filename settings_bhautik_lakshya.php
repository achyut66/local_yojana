...
if(isset($_POST['submit']))
{
    ...
    $form_data->unit_name = $_POST['unit_name'];
                ...
                <div class="userprofiletable">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="inputWrap">
                            ...
                            <div class="titleInput">भौतिक लक्ष्यको एकाइ:</div>
                            <div class="newInput"><input type="text"  name="unit_name" value="<?php echo $data->unit_name;?>" required></div>
                        ...
                        <?php $i=1;foreach($budget_result as $result):?>
                            <tr>
                                ...
                                <td class="myCenter">
                                    ...
                                    >उपशिर्षक हेर्नुहोस</button></td>
                                <form method="post" action="bhautik_delete.php">
                                <td class="myCenter">
                                    <a href="settings_bhautik_lakshya.php?id=<?php echo $result->id; ?>"><input class="button-btn-primary" value="सच्च्याउनु होस्" type="button"></a>
