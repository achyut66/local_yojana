...
$data5 = AmanatLagat::find_by_plan_id($_GET['id']);//print_r($data5);
$data6 = Amanat_more_details::find_by_plan_id($_GET['id']);
// print_r($data6);
     ...
     if($data4->period==6)
    {
		...
		?>	
										<div class="banktextdetails">
											यस कार्यालयको स्वीकृत वार्षिक कार्यक्रम अनुसार <?php echo SITE_LOCATION;?> वडा नं.
                                            <?php if(!empty($data2)){?>
                                            <?php echo convertedcit($data2->program_organizer_group_address);?>
                                            <!--(योजनाको ठेगाना भएको वडा न)--> 
                                            <?php }else{
                                            echo convertedcit($data1->ward_no);
                                            ?>
                                            <?php }?>
                                            मा 
                                            <?php echo $data1->program_name; ?><!--(योजनाको नाम) --> 
                                            योजना स्वीकृत भइ मिती 
                                            <?php if(!empty($data3)){?>
                                            <?php echo convertedcit($data3->miti);?><!--(योजना संझौताको मिति) --> 
                                            <?php }else{
                                            echo convertedcit($data6->yojana_samjhauta_date);
                                            ?>
                                            <?php }?>
                                            मा यस <?php echo SITE_TYPE;?>सँग भएको संझौता अनुसार उक्त योजना मिति 
                                            <?php if(!empty($data3)){?>
                                            <?php echo convertedcit($data3->yojana_start_date);?>
                                            <?php }else{
                                            echo convertedcit($data6->yojana_start_date);
                                            ?>
                                            <?php }?>
                                            <!--(योजना शुरु हुने मिति)--> देखी काम सुरु गरी मिती 
                                            <?php if(!empty($data3)){?>
                                            <?php echo convertedcit($data3->yojana_sakine_date);?>
                                            <?php }else{
                                            echo convertedcit($data6->yojana_sakine_date);
                                            ?>
                                            <?php }?>
                                            <!--(योजना सम्पन्न हुने मिति)--> भित्रमा  काम
                                            सम्पन्न गर्ने गरी 
                                            <?php if(!empty($data3)){?>
                                            उपभोक्ता समिति सँग सम्झौता गरी 
                                            <?php }else{}?>
                                            योजनाको कार्यदेश दिइएकोमा 
                                            <?php if(!empty($data3)){?>
                                            उपभोक्ता समितिले मिति 
                                            <?php echo convertedcit($data4->letter_date);?>
                                            <!--(म्याद थपको लागी उपभोक्ता समितिले निबेदन दिएको मिती)-->
                                            मा 
                                            <?php }else{}?>
                                            यस कार्यालयमा <?php echo $data4->program_problem_reason;?>
                                            <!--(योजना म्याद भित्र नसकिनुको कारण)-->  
                                            कारणले तोकिएको समयमा योजना सम्पन्न गर्न नसकिएको भनि म्याद थपका लागी निबेदन दिएकाले 
                                            नियम अनुसार <?php echo $period;?> पटक मिति 
                                            <?php echo convertedcit($data4->extended_date);?><!--(थपिएको म्यादको अबधी)--> 
