...
if(empty($upabhokta_letter_content))
{
    ...
    $upabhokta_letter_content->letter_name = 'peski_tippani';
...
$data5 = Planstartingfund::find_by_sql("select * from plan_starting_fund where peski_stat=".$peski);//print_r($data5);
?> 
                                ...
                                <div style="color:red">
									...
									<div class="printContent">
										...
										<div class="banktextdetails">
											    ...
											    </b> र  उपभोक्ताबाट जनश्रमदान रु 
                                                <b><?php echo convertedcit($data3->costumer_investment);?></b> भएकोमा मिति 
                                                ...
                                                <?php foreach($data5 as $data5):?>
                                                    <b>
                                                         <?php echo convertedcit($data5->advance_return_date);?>
                                                    </b>
                                                भित्रमा पेश्की फर्छयौट  गरी 
                                                <?=$new_data1?> र 
                                                ...
                                                <b>
                                                    <?php echo convertedcit($data5->advance);?>
                                                </b>
                                                <?php endforeach;?>
