        ...
        <h2 class="dashboard">ठेक्का  संचालन प्रकृया | <a href="contract_dashboard.php?id=<?= $program_id ?>" class="btn" >पछी जानुहोस </a></h2>
            ...
            <div class="grid-container">
                ...
                <h2>ठेक्का पेस्की/म्याद थप/मुल्यांकन र अन्तिम भुक्तानी सम्बन्धित पत्रहरु छान्नुहोस् </h2>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                                                <a href="ethekka_peski_tippani.php" target="_blank">
                        ...
                        <div class="col-md-4">
                                                <a href="ethekka_myadthap_tippani.php" target="_blank">
                                                    <p id="rcorners1" class="text-center" style="font-size: 22px;">म्यादथप को टिप्पणी<br>
                                                    <img src="images/n/patra.png" alt="Upabhokta Icon" class="dashimg" />
                                                </p>
                                                </a>
                                                </div>
                        ...
                        <div class="col-md-4">
                                                <a href="ethekka_final_tippani.php" target="_blank">
