                       ...
                       <form method="post" enctype="multipart/form_data">
                            ...
                            <div class="inputWrap100">
                            	<div class="inputWrap33 inputWrapLeft text-left">
                                    <!-- <div class="add btn myWidth100">थप्नुहोस [+]</div> -->
                                    <input type="button" class="add button btn-primary mywidth33" value="थप्नुहोस [+]">
                                </div>
                                <div class="inputWrap33 inputWrapLeft text-center">
                                    <!-- <div class="remove btn myWidth100">हटाउनुहोस [-]</div> -->
                                    <input type="button" class="remove button btn-danger" value="हटाउनुहोस [-]">
                                </div>
