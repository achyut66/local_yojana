      ...
      <div class="OurContentFull">
        ...
        <div class="userprofiletable">
          ...
          <div>
            ...
            <form id="f" method="post" enctype="multipart/form_data" action="save_plandetails1.php">
            ...
            <div class="anudan_item">
              <div class="titleInput">
                <div style="display:flex">
                  ...
                  <div class="remove_anudan" data-anudan-id="0"
                    style="color:red;border:none;cursor:pointer;align-self:center;padding:0px 10px">X</div>
                </div>
            ...
            <div class="anudan_item">
              <div class="titleInput">
                <div style="display:flex">
                  ...
                  <div class="remove_anudan" data-anudan-id="1"
                    style="color:red;border:none;cursor:pointer;align-self:center;padding:0px 10px">X</div>
                </div>
            ...
            <div class="anudan_item">
              <div class="titleInput">
                <div style="display:flex">
                  ...
                  <div class="remove_anudan" data-anudan-id="1"
                    style="color:red;border:none;cursor:pointer;align-self:center;padding:0px 10px">X</button>
                </div>
          ...
          <center>
            <div id="handleAddNew" class="btn">ADD NEW</div>
          </center>
          <br>
        ...
        <div class="inputWrap33 inputWrapLeft">
          ...
          <input type="hidden" id="contingency_form_data" name="contingency_form_data">
          <p id="added_marmat_samhar">मर्मत संहार : <span id="added_marmat_samhar_data"></span></p>
          <input type="hidden" id="marmat_form_data" name="marmat_form_data">
        </div>
...
<div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="newModalLabel" aria-hidden="true">
  ...
  <input type="hidden" name="create_id" id="plan_id"
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-right">
        <input type="submit" style="width:33%%" name="submit"
            value="<?=$value?>" class="submit button btn-success submit_form">
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    JQ(document).ready(function() {
      ...
      JQ(document).on('click', '#handleAddNew', function(e) {
        ...
        const html = `<div class="anudan_item">
                  ...
                  <div style="display:flex">
                      ...
                      <div class="remove_anudan" data-anudan-id="1" style="color:red;border:none;cursor:pointer;align-self:center;padding:0px 10px">X</div>
                    </div>
                    <input 
                      type="checkbox"  
      ...
      JQ(document).on('submit', '#plan_form', function(e) {
        JQ('#contingency_form_data').val(+JQ('#contingency_data').text());
        JQ('#marmat_form_data').val(+JQ('#added_marmat_samhar_data').text());
      });
    });
  </script>