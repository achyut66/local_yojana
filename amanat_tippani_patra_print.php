...
//dynamic data
$upabhokta_letter_content = UpabhoktaLetterContent::find_by_letter_plan_id('amanat_tippani',$_GET['id']);
if(empty($upabhokta_letter_content))
{
    $upabhokta_letter_content = new UpabhoktaLetterContent();
    $upabhokta_letter_content->plan_id = $_GET['id'];
    $upabhokta_letter_content->letter_name = 'amanat_tippani';
    $upabhokta_letter_content->data1 = $_GET['data1'];
    $upabhokta_letter_content->data2 = $_GET['data2'];
    $upabhokta_letter_content->save();
}else {
    if ($data1 != $upabhokta_letter_content->data1) {
        $upabhokta_letter_content->data1 = $data1;
    }
    if ($data2 != $upabhokta_letter_content->data2) {
        $upabhokta_letter_content->data2 = $data2;
    }
}
           ...
           <div class="printPage">
               ...
               <div class="printContent">
                  ...
                  <div class="banktextdetails">
                               <strong><?php echo SITE_LOCATION;?></strong> <strong><?php echo convertedcit($data1->ward_no)?></strong>
                                नं वडा कार्यालयको च.नं. <strong><?php echo convertedcit($data3->chalani_no)?></strong> मिति 
                                <strong><?php echo convertedcit($data3->yojana_samjhauta_date)?></strong> को पत्रानुसार सो 
                                <strong><?php echo $data1->program_name;?></strong> कार्यको लागि लागत अनुमान सहित रकम उपलब्ध गराई 
                                दिन हुन अनुरोध भई आएकोमा <strong><?php echo $data3->aadesh_per_post;?></strong>वाट <strong>
                                    <?php echo Topicbudget::getName($data1->budget_id);?></strong>वाट कार्य गराउने आदेश भए वमोजिम उक्त 
                                    कार्यको लागी तयार भएको लागत अनुमान रू.<strong><?php echo convertedcit($data2->total_investment);?></strong>
                                     स्विकृत गरी चालु आर्थिक वर्ष <strong><?php echo convertedcit($fiscal->year)?></strong>  
                                     को वार्षिक कार्यक्रमको <strong><?php echo Topicareatype::getName($data1->topic_area_type_id)?></strong> 
                                     को <strong><?php echo Topicbudget::getName($data1->budget_id);?></strong>वाट खर्च लेख्ने गरी 
                                     <?=$new_data1?>
                                     अमानतवाट स्विकृत लागत अनुमान वमोजिम कार्य गर्ने गरी <strong><?php echo $data3->organizer_name;?></strong>लाई कायदिश दिने सम्वन्धमा निर्णयार्थ पेश गर्दछु ।
                              </div>
                            <div class="myspacer20"></div>
