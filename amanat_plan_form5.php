...
if(isset($_POST['submit']))
{
    ...
    else
    {
        ...
        echo alertBox("भुक्तानी गर्न सफल ","amanat_plan_form5.php");
    }
        ...
        <div class="OurContentFull">
            ...
            <div class="userprofiletable">
                ...
                <div class="myCenter">
                    ...
                    <?php
                    if($mode=="superadmin"){?>
                        <a onClick="return confirm('के तपाई डेटा हाटाउन चाहनुहुन्छ ?');" href="amanat_bhuktani_delete.php?plan_id=<?php echo $_GET['id'];?>"><button class="btn">अन्तिम भुक्तानी हटाउनु होस्</button></a>
                    <?php }
                ...
                <div <?php if(!empty($data_selected_final)): ?> style="display:none;" <?php endif; ?>>
                    <form method="post" enctype="multipart/form-data" >
                        ...
                        <div class="inputWrap33 inputWrapLeft">
                            ...
                            <?php if(empty($amanat_lagat)&&(empty($total_inv))){?>
                        ...
                        <div class="inputWrap33 inputWrapLeft">
                            ...
                            <div class="newInput"><input type="text" name="final_contengency_amount" id="" value="<?=$total_inv->contigency_amount?>" /></div>
