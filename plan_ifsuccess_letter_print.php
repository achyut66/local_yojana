...
?>
	...
	$bhautik_analysis_pragati = Bhautik_lakshya::find_by_plan_id_and_type_payment_count($_GET['id'], 2, 1);
	$profit = Profitablefamilydetails::find_by_plan_id($_GET['id']);//print_r($profit);
	$data_4 = Analysisbasedwithdraw::find_by_plan_id($_GET['id']);
	?>
    	...
    	<div class="userprofiletable">
             <div class="printPage">
             	<div class="image-wrapper">
									...
									<h4 style="margin-left:-3px;">(योजना फाँटको लागि)</h4>
									...
									<?php if(!empty($data_4)){?>
										<br>
										<div class="text-center"><strong><u>मुल्यांकन सम्मको भौतिक प्रगति</u></strong></div>
										<?php $i=1; foreach($bhautik_analysis_pragati as $bl):?>
									    <table class="table-bordered">
									        <tr>
									            <td width="20%"><?php echo convertedcit($i)?></td>
									            <td width="40%"><?php echo SettingbhautikPariman::getName($bl->details_id)?></td>
									...
									<?php }else{}?>
									<br>
									<div class="text-center"><strong><u>अन्तिम भुक्तानी सम्मको भौतिक प्रगति</u></strong></div>
