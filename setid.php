...
else
{
 ...
 $black = CostumerBlackList::find_by_plan_id($_POST['sn']);
...
if (!empty($d_activate))
{
    echo alertBox("निम्न दर्ता को योजना निस्क्रिय गरिएको छ!!! -- सम्झौता गर्न असफल !!!","setid.php");
}
if (!empty($black))
{
    echo alertBox("निम्न योजनाको उपभोक्ता समिति कालो सुचिमा परेको छ !!!! सम्झौता गराउन कालो सुचीको लिस्टबाट हटाउनुहोला !!! योजना सम्झौता गराउन असफल !!!", "setid.php");
}
//if($result)
