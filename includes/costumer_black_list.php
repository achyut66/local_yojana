...
class CostumerBlackList
{
    protected static $table_name = "costumer_black_list";
    protected static $db_fields = array('id','plan_id','costumer_name','program_name','black_list_reason');
