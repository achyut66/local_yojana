...
class QuotationLetterContent
{
    protected static $table_name = "quotation_letter_content";
    protected static $db_fields = array('id','plan_id','letter','content_1',
            'content_2','content_3');
    public $id;
    public $plan_id;
    public $letter;
    ...
    public static function find_by_letter_plan_id($letter='',$id=0)
    {
        global $database;
        $result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$id} and letter='{$letter}' limit 1");
        return !empty($result_array)? array_shift($result_array) : false;
    }
