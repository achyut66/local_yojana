...
class Planstartingfund
{
	...
	protected static $db_fields = array('id','advance','advance_taken_date','peski_stat','advance_taken_date_english','advance_return_date_english','advance_taken_group','advance_taken_group_address','advance_return_date','advance_reason','plan_id','created_date');
	public $id;
	public $advance ;
	...
	public static function find_by_peski($id=0)
	{
		global $database;
		$result_array=self::find_by_sql("select * from ".self::$table_name. " where peski_stat={$id} limit 1");
		return !empty($result_array)? array_shift($result_array) : false;
	}
