...
class UpabhoktaLetterContent
{
    protected static $table_name = "upabhokta_letter_content";
    protected static $db_fields = array('id','plan_id','letter_name','data1',
            'data2','data3');
    public $id;
    public $plan_id;
    public $letter_name;
    ...
    public static function find_by_letter_plan_id($letter_name='',$id=0)
    {
        global $database;
        $result_array=self::find_by_sql("select * from ".self::$table_name. " where plan_id={$id} and letter_name='{$letter_name}' limit 1");
        return !empty($result_array)? array_shift($result_array) : false;
    }
