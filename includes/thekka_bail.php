...
class ThekkaBail
{
    protected static $table_name = "thekka_bail";
	protected static $db_fields = array('id','bail_name','bail_percent','bail_amount');
...
//                echo $sql."<br>";
		...
		// public static function get_sum_qty($details_id)
		// {
        //     global $database;
        //     $sql = "SELECT details_id,unit_id,plan_id,type,sum(qty) FROM bhautik_lakshya WHERE details_id =".$details_id;
		// 	return 
		// }
