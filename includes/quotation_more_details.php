...
class Quotationmoredetails
{
	...
	protected static $db_fields = array('id','yojana_start_date','yojana_end_date','yojana_place','yojana_description','miti','samjhauta_party','post_id_3','plan_id');
	public $id;
	public $yojana_start_date;
        public $yojana_end_date;
        public $yojana_place;
        public $yojana_description;
