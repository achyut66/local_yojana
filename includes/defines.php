...
defined("SITE_ROOT")? NULL : define('SITE_ROOT',$_SERVER['DOCUMENT_ROOT'].DS.'new_yojana'.DS);
...
defined("SITE_NAME")? NULL : define('SITE_NAME','नमुना ');
defined("SITE_FIRST_NAME")? NULL : define('SITE_FIRST_NAME','नमुना ');
defined("SITE_TYPE")? NULL : define('SITE_TYPE','नगरपालिका');
defined("SITE_LOCATION")? NULL : define('SITE_LOCATION','नमुना नगरपालिका');
defined("SITE_ADDRESS")? NULL : define('SITE_ADDRESS','बाफल, काठमाण्डौं');
defined("SITE_HEADING")? NULL : define('SITE_HEADING','नगरकार्यपालिकाको कार्यालय');
defined("SITE_SUBHEADING")? NULL : define('SITE_SUBHEADING','Namuna Municipality ');
defined("SITE_SECONDSUBHEADING")? NULL: define('SITE_SECONDSUBHEADING', 'बागमती प्रदेश, नेपाल');
defined("SITE_SUBADDRESS")? NULL : define('SITE_SUBADDRESS','नं वडा कार्यलय');;
defined("SITE_OFFICE")? NULL : define('SITE_OFFICE','BMS');
defined("SITE_DISTRICT")? NULL : define('SITE_DISTRICT','काठमाडौँ');
defined("SITE_OFFICE_WEB")? NULL : define('SITE_OFFICE_WEB','http://bmsnepal.net');
defined("SITE_ZONE")? NULL : define('SITE_ZONE','काठमाण्डौं');
