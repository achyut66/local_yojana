...
//dynamic data
$upabhokta_letter_content = UpabhoktaLetterContent::find_by_letter_plan_id('thekka_tippani',$_GET['id']);
if(empty($upabhokta_letter_content))
{
    ...
    $upabhokta_letter_content->letter_name = 'thekka_tippani';
                ...
                <div class="image-wrapper">
                    ...
                    <div class="myspacer"></div>
									...
									<div class="chalanino">योजना दर्ता नं : <?php echo convertedcit($_GET['id'])?></div></div>
                                        ...
                                        यस कार्यालयको आ.ब <?php echo convertedcit(Fiscalyear::getName($data1->fiscal_id));?>
                                         को कार्यक्रम अनुसार  <b><u><?php echo$data1->program_name;?></u></b> 
                                         योजना ठेक्का मार्फत संचालन गर्ने गरी मिति  <?php echo convertedcit($data3->created_date);?> 
                                         मा  सुचना प्रकाशन गरिएकोमा उक्त योजना ठेक्का मार्फत संचालन गर्न तपशिल बमोजिमका फर्म/कम्पनीले ठेक्काको
                                          बोलपत्र पेश भएको। 
										</div>
...
//                                                     print_r($result);exit;
                                        ...
                                        <div class="bankdetails">
                                          माथि उल्लेखित फर्म/कम्पनीहरुबाट प्राप्त बोलपत्र प्रस्ताब मध्ये सबै भन्दा घटी कबोल गर्ने श्री 
                                          <?php echo $name->contractor_name;?> को रित पुर्बकको कबोल अंक सबै भन्दा घटी रकम 
                                          ( भ्याट बाहेक ) रु <?php echo convertedcit(placeholder($data5->bid_amount));?>   
                                          अक्षरुपी <?= convert($data5->bid_amount)?> मात्र भएकाले 
                                          <?=$new_data1?>
                                          निज सँग ठेक्का संझौताको लागी निर्णयार्थ यो टिप्पणी पेश गरेको छु । 
                                        </div>
