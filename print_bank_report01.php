                                ...
                                <h5 class="marginright1 letter-title-four">
									...
									<div class="printContent">
										...
										<div class="banktextdetails">
											...
											उपरोक्त बिषयमा यस <b><?php echo SITE_TYPE;?> 
											</b> र <b><u><?php echo $data->program_organizer_group_name;?></u></b>
											<!--(योजनाको संचालन गर्ने उपभोक्ता समितिको नाम)--> बिच मिति 
											<b><?php echo convertedcit($data2->miti);?></b><!--(योजना संझौता भएको मिति)-->
											मा <b><?php echo $data1->program_name;?></b> योजना संचालन गर्ने भनि संझौता भएकोमा उक्त्त योजना  
											संचालन गर्न उपभोक्ता समितिको नाममा बैंक खाता आबश्यक भएकाले उपभोक्ता समितिका 
											<input type="checkbox" name="adaksh" value="अध्यक्ष श्री <?php echo $data3->name;?>">
											अध्यक्ष श्री 
											<b><?php echo $data3->name;?></b><!--(नामथर)--> , 
											<input type="checkbox" name="sachib" value="सचिब श्री <?php echo $data3_1->name;?>">
											सचिब श्री 
											<b><?php echo $data3_1->name;?></b><!--(नामथर)-->
											<input type="checkbox" name="kosh" value="र कोषाध्यक्ष श्री <?php echo $data3_2->name;?>">
											र कोषाध्यक्ष श्री 
											<b><?php echo $data3_2->name;?></b><!--(नामथर)--> 
