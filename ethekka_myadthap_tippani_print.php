...
$data5 = Ethekka_lagat::find_by_plan_id($_GET['id']);
										...
										<?php if($data4->period==1)
 {
     ...
     if($data4->period==6)
    {
		...
		?>	
                                        ...
                                        यस कार्यालयको स्वीकृत वार्षिक कार्यक्रम अनुसार नमुना नगरपालिका वडा नं. <strong><?=convertedcit($data1->ward_no)?></strong>
                                        मा <strong><?=$data1->program_name?></strong> योजना स्वीकृत भइ मिती 
                                        <strong><?=convertedcit($data5->yojanaa_samjhauta_date)?></strong>
                                        मा यस <strong><?=SITE_TYPE.'संग'?></strong> भएको 
                                        संझौता अनुसार उक्त योजना मिति 
                                        <strong><?=convertedcit($data5->yojana_start_date)?></strong>
                                        देखी काम सुरु गरी मिती 
                                        <strong><?=convertedcit($data5->yojana_end_date)?></strong>
                                        भित्रमा काम सम्पन्न गर्ने
                                        गरी योजनाको कार्यदेश दिइएकोमा यस कार्यालयमा 
                                        <strong><?=$data4->program_problem_reason?></strong>
                                        कारणले तोकिएको समयमा 
                                        योजना सम्पन्न गर्न नसकिएको भनि म्याद थपका लागी निबेदन दिएकाले नियम अनुसार 
                                        <strong><?=$period?></strong>
                                        पटक 
                                        मिति 
                                        <strong><?=convertedcit($data4->extended_date)?></strong>
                                        सम्मका लागी योजना संचालनको समय थप गर्नका लागी श्रीमान समक्ष 
                                        यो टिप्पणी पेश गरको छु ।
										</div>
