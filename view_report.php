...
<div class="">
    <div class="">
        <div class="maincontent">
            <h2 class="headinguserprofile">सकिएको योजनाको रिपोर्ट हेर्नुहोस | 
                <a href="report.php" class="btn">पछि जानुहोस </a> | <a href="view_report_excel.php?ward_no=<?=$_GET['ward_no']?>" class="btn">Excel Export</a> | <a target="_blank" href="view_report_print.php?ward_no=<?=$_GET['ward_no']?>" class="btn">Print</a></h2>
